...
public class Evaluator {
  ...
  public void process(){
      while(operatorStack.peek().priority() > 1 ){
        ...
        Operand oper2 = operandStack.pop();
        Operand oper1 = operandStack.pop();
        operandStack.push( oldOperator.execute( oper1, oper2));
      }
      operatorStack.pop();
  }
  public int eval( String expression ) {
    ...
    while(operatorStack.peek().priority() > 0){
        ...
        operandStack.push(Opr.execute(operand1, operand2));
    }
